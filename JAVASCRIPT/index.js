...
function preecherTabela() {
    data.forEach(e => {
        ...
        let cria = document.createElement("td");
        excluir.innerHTML = `<img onclick="excluir.setAttribute('style','display:flex')" src='../../assets/exclui.png' width='40px' height='40px' />`;
        cpf.innerHTML = e.cpf;
        ...
        cria.innerHTML = `<img onclick="modal1.setAttribute('style','display:flex')" src='../../assets/mais.png' width='40px' height='40px' />`;
