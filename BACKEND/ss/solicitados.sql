...
---------------------------------------------------------------------------
drop procedure if exists cria_uma_sol;
delimiter //
create procedure cria_uma_sol(n_sol int,depto int,func int,prod int,qtd int,total float)
BEGIN
...
call cria_uma_sol(1055,1000,100,125,1,10);